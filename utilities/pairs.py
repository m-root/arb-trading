...
from utilities.requests import get_allPairAddress
from utilities.requests import get_allPairInfo
from utilities.log_builder import logger

def getAllPairAddress(eth_http:str, pairs_file:str="utilities/files/all_pair_address.json",
...
def getAllPairInfo(eth_http:str, pairs_file:str="utilities/files/all_pair_info.json",
